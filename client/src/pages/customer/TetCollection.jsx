// TetCollection.jsx - Trang bộ sưu tập Tết
...
const TetCollection = () => {
  ...
  // Khởi tạo dữ liệu
  useEffect(() => {
    const data = getProductsData('tet'); // Luôn lấy theme Tết
    ...
    <div className="min-h-screen bg-red-50">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="absolute -top-16 left-0 w-32 h-32 bg-contain bg-no-repeat bg-center opacity-50"
          style={{ backgroundImage: "url('/decorations/lantern-left.png')" }}
        />
        <div className="absolute -top-16 right-0 w-32 h-32 bg-contain bg-no-repeat bg-center opacity-50"
          style={{ backgroundImage: "url('/decorations/lantern-right.png')" }}
        />
      </div>

      <div className="container mx-auto px-4 mt-3 pb-20">
        {/* Search and Filter Bar */}
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-lg p-8 mb-12 border-2 border-red-100">
          <div className="space-y-8">
            ...
            <div className="relative max-w-2xl mx-auto">
              <div className="relative">
                <input
                  ...
                  className="w-full h-12 pl-12 pr-4 bg-red-50/50 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 transition-all"
                  value={searchTerm}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <select
                  className="w-full h-12 px-4 bg-red-50/50 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500 transition-all cursor-pointer"
        ...
        {/* Products Grid */}
        {products.length === 0 ? (
          <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-lg p-16 text-center border-2 border-red-100">
            <div className="mb-6">
          ...
          <>
            ...
            <div className="bg-gradient-to-r from-red-600 to-red-400 text-white py-4 px-6 rounded-xl mb-8 flex items-center justify-between">
              <div>
                <h3 className="text-xl font-bold">Bộ Sưu Tập Tết 2025</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {currentProducts.map((product) => (
                <Link 
                  ...
                  className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all group border-2 border-red-100"
                >
                  {/* Product Image */}
                  <div className="relative aspect-[3/4] overflow-hidden">
                    ...
                    {product.tag && (
                      <div className="absolute top-4 left-4 bg-yellow-500/90 backdrop-blur-xl text-red-700 px-3 py-1 rounded-lg font-medium">
                        {product.tag}
                      </div>
                    )}
                  </div>
