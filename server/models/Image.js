...
const ImageSchema = new mongoose.Schema({
    ...
    variantID: {
        ...
        ref: 'ProductVariant', // Tham chiếu tới collection ProductVariants
        required: false, // Không bắt buộc
    },
    productID: {
        type: mongoose.Schema.Types.ObjectId,
        ref: 'Product', // Tham chiếu tới collection Products
        required: true, // Bắt buộc phải có mã sản phẩm
    },
}, { versionKey: false, timestamps: true }); // Tự động thêm trường createdAt và updatedAt
